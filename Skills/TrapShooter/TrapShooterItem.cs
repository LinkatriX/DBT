...
{
    public sealed class TrapShooterItem : SkillItem<KiBlastProjectile>
    {
        public TrapShooterItem() : base(SkillDefinitionManager.Instance.TrapShooter, 20, 20, ItemRarityID.Lime, false)
        {
        }
