...
namespace DBT.Projectiles
{
    public abstract class AbstractChargeBall : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            DrawChargeBall(spriteBatch, Main.projectileTexture[projectile.type], originalRotation, projectile.scale, MAX_DISTANCE, Color.White);
            return false;
        }
        ...
        public void DrawChargeBall(SpriteBatch spriteBatch, Texture2D texture, float rotation = 0f, float scale = 1f, float maxDist = 2000f, Color color = default(Color))
        {
            spriteBatch.End();
        ...
        private SkillDefinition Definition { get; set; }
    }
}
