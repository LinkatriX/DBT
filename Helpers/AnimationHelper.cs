...
{ 
    ...
    {
        public static readonly PlayerLayer auraEffect = new PlayerLayer("DBT", "AuraEffects", null, delegate (PlayerDrawInfo drawInfo)
        {
            ...
            AuraAnimationInformation aura = modPlayer.GetAura();//DBTPlayer.Auras line 36

            if (aura != null) 
            {
                // we don't do player draw data, we do a custom draw.                
                PlayerExtensions.DrawAura(modPlayer, aura);
            }
        });
