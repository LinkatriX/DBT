...
{
    public sealed class EnergyShotItem : SkillItem<KiBlastProjectile>
    {
        public EnergyShotItem() : base(SkillDefinitionManager.Instance.EnergyShot, 20, 20, ItemRarityID.Lime, false)
        {
        }
