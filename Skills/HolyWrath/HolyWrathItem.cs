...
{
    public sealed class HolyWrathItem : SkillItem<KiBlastProjectile>
    {
        public HolyWrathItem() : base(SkillDefinitionManager.Instance.HolyWrath, 20, 20, ItemRarityID.Lime, false)
        {
        }
