...
{
    public sealed class SuperEnergyBarrageItem : SkillItem<KiBlastProjectile>
    {
        public SuperEnergyBarrageItem() : base(SkillDefinitionManager.Instance.SuperEnergyBarrage, 20, 20, ItemRarityID.Lime, false)
        {
        }
