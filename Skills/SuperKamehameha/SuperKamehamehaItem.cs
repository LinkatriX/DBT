...
{
    public sealed class SuperKamehamehaItem : SkillItem<KiBlastProjectile>
    {
        public SuperKamehamehaItem() : base(SkillDefinitionManager.Instance.SuperKamehameha, 20, 20, ItemRarityID.Lime, false)
        {
        }
