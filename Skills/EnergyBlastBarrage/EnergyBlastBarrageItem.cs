...
{
    public sealed class EnergyBlastBarrageItem : SkillItem<KiBlastProjectile>
    {
        public EnergyBlastBarrageItem() : base(SkillDefinitionManager.Instance.EnergyBlastBarrage, 20, 20, ItemRarityID.Lime, false)
        {
        }
