...
{
    public sealed class DemonBarrageItem : SkillItem<DemonBarrageProjectile>
    {
        public DemonBarrageItem() : base(SkillDefinitionManager.Instance.DemonBarrage, 20, 20, ItemRarityID.Blue, false)
        {
        }
