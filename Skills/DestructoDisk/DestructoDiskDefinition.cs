namespace DBT.Skills.DestructoDisk
{
    ...
    {//Add armor piercing.
        public DestructoDiskDefinition() : base("DestructoDisk", "Destructo Disk", "Fires a disk that is capable of cutting through enemies. Charge to unleash a more powerful version.", typeof(DestructoDiskItem), new DestructoDiskCharacteristics())
        {
        }
    }
