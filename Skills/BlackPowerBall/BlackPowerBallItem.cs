...
{
    public sealed class BlackPowerBallItem : SkillItem<KiBlastProjectile>
    {
        public BlackPowerBallItem() : base(SkillDefinitionManager.Instance.BlackPowerBall, 20, 20, ItemRarityID.Lime, false)
        {
        }
