...
{
    public sealed class SpiritBombItem : SkillItem<KiBlastProjectile>
    {
        public SpiritBombItem() : base(SkillDefinitionManager.Instance.SpiritBomb, 20, 20, ItemRarityID.Lime, false)
        {
        }
