namespace DBT.Skills.SuperEnergyBarrage
{
    ...
    {
        public SuperEnergyBarrageDefinition() : base("SuperEnergyBarrage", "Super Energy Barrage", "Fires a powerful barrage of energy blasts.", new SuperEnergyBarrageCharacteristics())
        {
        }
    }
