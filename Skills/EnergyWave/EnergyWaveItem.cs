...
{
    public sealed class EnergyWaveItem : SkillItem<KiBlastProjectile>
    {
        public EnergyWaveItem() : base(SkillDefinitionManager.Instance.EnergyWave, 20, 20, ItemRarityID.Lime, false)
        {
        }
