namespace DBT.Skills.EnergyBlastBarrage
{
    ...
    {
        public EnergyBlastBarrageDefinition() : base("EnergyBlastBarrage", "Energy Blast Barrage", "Fires off continuous ki blasts. Charge to increase the length of the barrage.", typeof(EnergyBlastBarrageItem), new EnergyBlastBarrageCharacteristics())
        {
        }
    }
