...
{
    public sealed class EnergyBurstItem : GuardianSkillItem<EnergyBurstProjectile>
    {
        public EnergyBurstItem() : base(GuardianDefinitionManager.Instance.EnergyBurst, 20, 20, ItemRarityID.Blue, false)
        {
        }
