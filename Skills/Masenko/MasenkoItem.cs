...
{
    public sealed class MasenkoItem : SkillItem<KiBlastProjectile>
    {
        public MasenkoItem() : base(SkillDefinitionManager.Instance.Masenko, 20, 20, ItemRarityID.Lime, false)
        {
        }
