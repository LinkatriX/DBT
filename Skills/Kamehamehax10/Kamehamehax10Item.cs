...
{
    public sealed class Kamehamehax10Item : SkillItem<KiBlastProjectile>
    {
        public Kamehamehax10Item() : base(SkillDefinitionManager.Instance.Kamehamehax10, 20, 20, ItemRarityID.Lime, false)
        {
        }
