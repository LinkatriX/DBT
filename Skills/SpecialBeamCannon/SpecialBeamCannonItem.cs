...
{
    public sealed class SpecialBeamCannonItem : SkillItem<KiBlastProjectile>
    {
        public SpecialBeamCannonItem() : base(SkillDefinitionManager.Instance.SpecialBeamCannon, 20, 20, ItemRarityID.Lime, false)
        {
        }
