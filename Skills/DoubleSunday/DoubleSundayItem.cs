...
{
    public sealed class DoubleSundayItem : SkillItem<KiBlastProjectile>
    {
        public DoubleSundayItem() : base(SkillDefinitionManager.Instance.DoubleSunday, 20, 20, ItemRarityID.Lime, false)
        {
        }
