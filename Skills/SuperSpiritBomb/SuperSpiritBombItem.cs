...
{
    public sealed class SuperSpiritBombItem : SkillItem<KiBlastProjectile>
    {
        public SuperSpiritBombItem() : base(SkillDefinitionManager.Instance.SuperSpiritBomb, 20, 20, ItemRarityID.Lime, false)
        {
        }
