namespace DBT.Skills.CelestialRapture
{
    ...
    {
        public CelestialRaptureDefinition() : base("CelestialRapture", "Celestial Rapture", "Fires seeking ki blasts from all angles.", typeof(CelestialRaptureItem), new CelestialRaptureCharacteristics())
        {
        }
