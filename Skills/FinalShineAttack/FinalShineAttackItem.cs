...
{
    public sealed class FinalShineAttackItem : SkillItem<KiBlastProjectile>
    {
        public FinalShineAttackItem() : base(SkillDefinitionManager.Instance.FinalShineAttack, 20, 20, ItemRarityID.Lime, false)
        {
        }
