...
{
    public sealed class SupernovaItem : SkillItem<KiBlastProjectile>
    {
        public SupernovaItem() : base(SkillDefinitionManager.Instance.Supernova, 20, 20, ItemRarityID.Lime, false)
        {
        }
