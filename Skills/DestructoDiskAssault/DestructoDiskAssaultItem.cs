...
{
    public sealed class DestructoDiskAssaultItem : SkillItem<KiBlastProjectile>
    {
        public DestructoDiskAssaultItem() : base(SkillDefinitionManager.Instance.DestructoDiskAssault, 20, 20, ItemRarityID.Lime, false)
        {
        }
