...
{
    public class SaibaSnakeHead : ModNPC
    {
        internal int[] worms = new int[] { ModContent.NPCType<SaibaSnakeHead>(), ModContent.NPCType<SaibaSnakeBody>(), ModContent.NPCType<SaibaSnakeTail>() };
        ...
        {
            BaseAI.AIWorm(npc, worms, Main.rand.Next(3, 5));
        }
