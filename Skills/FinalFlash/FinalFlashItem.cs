...
{
    public sealed class FinalFlashItem : SkillItem<KiBlastProjectile>
    {
        public FinalFlashItem() : base(SkillDefinitionManager.Instance.FinalFlash, 20, 20, ItemRarityID.Lime, false)
        {
        }
