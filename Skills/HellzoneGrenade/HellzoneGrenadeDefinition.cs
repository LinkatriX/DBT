namespace DBT.Skills.HellzoneGrenade
{
    ...
    {
        public HellzoneGrenadeDefinition() : base("HellzoneGrenade", "Hellzone Grenade", "Fires a barrage of homing ki blasts.", typeof(HellzoneGrenadeItem), new HellzoneGrenadeCharactersitics())
        {
        }
    }
