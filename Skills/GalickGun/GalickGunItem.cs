...
{
    public sealed class GalickGunItem : SkillItem<KiBlastProjectile>
    {
        public GalickGunItem() : base(SkillDefinitionManager.Instance.GalickGun, 20, 20, ItemRarityID.Lime, false)
        {
        }
