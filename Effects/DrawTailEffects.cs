...
namespace DBT.Effects
{
    public sealed class DrawTailEffects : PlayerLayer
    {
        ...
        public static void DrawLayer(PlayerDrawInfo drawInfo)
        {
            ...
            Main.spriteBatch.Draw(texture, new Vector2(drawX, drawY), new Rectangle(0, frameSize * frame, texture.Width, frameSize), color, 0, new Vector2(texture.Width / 2f, texture.Height / 2f), 1f, spriteEffects, 0);
        }
    }
}
