...
{
    public sealed class DirtyFireworksItem : SkillItem<KiBlastProjectile>
    {
        public DirtyFireworksItem() : base(SkillDefinitionManager.Instance.DirtyFireworks, 20, 20, ItemRarityID.Lime, false)
        {
        }
